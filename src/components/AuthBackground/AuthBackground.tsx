...
const AuthBackground: React.FC<AuthBackgroundProps> = ({
  ...
  return (
    <div className="bg-[url('src/assets/images/background_noise.png')] w-screen h-screen  items-center flex justify-center relative ">
    
      <div className=" shadow-2xl w-[90%] h-[85%] flex flex-col justify-center items-center absolute right-0 ">
      
        <img className=" w-100 h-100 absolute top-4" src={logo} alt="" />
